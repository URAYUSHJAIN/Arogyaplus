    ...
    <section id="ai-features" className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <Link 
            to="/ai-analysis"
            className="bg-blue-100 text-white px-8 py-4 rounded-full font-bold hover:bg-blue-700 hover:shadow-2xl transform hover:scale-105 transition-all duration-300 mt-8 inline-block border-2 border-blue-600"
          >
